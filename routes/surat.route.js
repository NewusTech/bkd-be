...
route.get('/user/surat/:idlayanan', [mid.checkRolesAndLogout(['Super Admin'])], suratController.getOutputSurat); 

//untuk print pdf berserta permohonan user
// route.get('/user/surat/:idlayanan/:idforminput', [mid.checkRolesAndLogout(['Super Admin', 'User'])], suratController.getSurat); 
