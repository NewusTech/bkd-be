...
route.post('/user/bkd/profile/create', [mid.checkRolesAndLogout(['Super Admin'])], BkdProfileController.createProfile);
...
route.put('/user/bkd/profile/update/:id', [mid.checkRolesAndLogout(['Super Admin'])], BkdProfileController.updateProfile); 
