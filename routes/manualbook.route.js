...
route.put('/user/manual/book/update/:id', [mid.checkRolesAndLogout(['Super Admin'])], upload.fields([{ name: 'manualbook', maxCount: 1 }]), manualbookController.updateManualBook);
