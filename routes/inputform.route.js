...
route.get('/user/form/:idlayanannum/barcode/get', [mid.checkRolesAndLogout(['Super Admin', 'Sekretaris Dinas', 'Kepala Dinas', 'Sekretaris Daerah' ])], layananforminput.getBarcode);
route.get('/user/form/:idlayanannum/data/barcode', layananforminput.getDataBarcode);
