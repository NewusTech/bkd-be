...
module.exports = {
  ...
  createBerita: async (req, res) => {
    try {
      ...
      res
        .status(201)
        .json(response(201, "success create berita", beritaCreate));
    } catch (err) {
  ...
  getBeritaBySlug: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(response(200, "success get berita by slug", beritaGet));
    } catch (err) {
      res.status(500).json(response(500, "internal server error", err));
      console.log(err);
    }
  ...
  updateBerita: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(response(200, "success update berita", beritaAfterUpdate));
    } catch (err) {
      res.status(500).json(response(500, "internal server error", err));
      console.log(err);
    }
