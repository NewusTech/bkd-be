...
module.exports = {
    ...
    getUserPelatihanByID: async (req, res) => {
        try {
            ...
            // Mencari data User_pelatihan dengan kondisi where
            ...
            if (!userGet) {
                return res.status(404).json(response(404, 'user data pelatihan not found'));
            }
    
            // Kirimkan response sukses dengan data User_pelatihan
            res.status(200).json(response(200, 'success get user pelatihan by id', userGet));
        } catch (err) {
    ...
    updateUserPelatihan: async (req, res) => {
        ...
        try {
            ...
            // Mengambil id pelatihan dari parameter URL
            const pelatihanId = req.params.id;
    
            // Cek apakah data pelatihan ada
            let userPelatihan = await User_pelatihan.findOne({
                where: {
                    id: pelatihanId,
                    user_id: userId,
                    deletedAt: null 
            ...
            if (!userPelatihan) {
                return res.status(404).json({
                    status: 404,
                    message: 'User data pelatihan tidak ditemukan'
                });
            }
            ...
            await User_pelatihan.update({
                uraian_pelatihan: req.body.uraian_pelatihan,
                lama_pelatihan: req.body.lama_pelatihan,
                no_surat_pelatihan: req.body.no_surat_pelatihan,
                tanggal_pelatihan: req.body.tanggal_pelatihan,
                tempat_pelatihan: req.body.tempat_pelatihan
            }, {
                where: {
                    id: pelatihanId,
                    user_id: userId
            ...
            res.status(200).json({
                status: 200,
                message: 'User data pelatihan berhasil diupdate'
            });
    ...
    deleteUserPelatihan: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json({
                status: 200,
                message: 'User data pelatihan berhasil dihapus'
            });
