...
module.exports = {
  ...
  createBkdStruktur: async (req, res) => {
    try {
      ...
      res
        .status(201)
        .json(response(201, "success create bkd struktur", bkdstrukturCreate));
    } catch (err) {
  ...
  getBkdStrukturBySlug: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(
          response(200, "success get bkd struktur by slug", bkdstrukturGet)
        );
    } catch (err) {
      res.status(500).json(response(500, "internal server error", err));
      console.log(err);
  ...
  updateBkdStruktur: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(
          response(200, "success update bkd struktur", bkdstrukturAfterUpdate)
        );
    } catch (err) {
      res.status(500).json(response(500, "internal server error", err));
      console.log(err);
