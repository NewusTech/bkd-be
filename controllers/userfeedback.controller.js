...
const { Surveyforminput, User_feedback, Surveyform, Layanan, User_info, sequelize, Instansi } = require('../models');
...
module.exports = {
    ...
    getFeedbackByLayanan: async (req, res) => {
        try {
